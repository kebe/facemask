...
class Net(nn.Module):
    ...
    def train(dataset):
        ...
        torch.save(train_images_tensor, 'tensor_data/train_images_tensor.pt')
        torch.save(train_labels_tensor, 'tensor_data/train_labels_tensor.pt')
        torch.save(val_images_tensor, 'tensor_data/val_images_tensor.pt')
        torch.save(val_labels_tensor, 'tensor_data/val_labels_tensor.pt')
        torch.save(test_images_tensor, 'tensor_data/test_images_tensor.pt')
        torch.save(test_labels_tensor, 'tensor_data/test_labels_tensor.pt')

        # train_images_tensor = torch.load('tensor_data/train_images_tensor.pt')
        # train_labels_tensor = torch.load('tensor_data/train_labels_tensor.pt')
        # val_images_tensor = torch.load('tensor_data/val_images_tensor.pt')
        # val_labels_tensor = torch.load('tensor_data/val_labels_tensor.pt')
        # test_images_tensor = torch.load('tensor_data/test_images_tensor.pt')
        # test_labels_tensor = torch.load('tensor_data/test_labels_tensor.pt')
        #import pdb; pdb.set_trace()
        net = Net()
